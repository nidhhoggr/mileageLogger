...
namespace Supra\Bundle\MileageBundle\Tests\Controller;
...
class LocationControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'supra_bundle_mileagebundle_locationtype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'supra_bundle_mileagebundle_locationtype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
