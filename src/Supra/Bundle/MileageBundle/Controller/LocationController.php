...
use Supra\Bundle\MileageBundle\Entity\Location;
use Supra\Bundle\MileageBundle\Form\LocationType;
...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SupraMileageBundle:Location')->findAll();
     ...
     * @Method("POST")
     * @Template("SupraMileageBundle:Location:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SupraMileageBundle:Location')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SupraMileageBundle:Location:edit.html.twig")
     */
